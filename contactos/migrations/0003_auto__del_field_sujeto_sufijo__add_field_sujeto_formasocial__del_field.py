...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Sujeto.sufijo'
        db.delete_column(u'contactos_sujeto', 'sufijo')

        # Adding field 'Sujeto.formasocial'
        db.add_column(u'contactos_sujeto', 'formasocial',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Sector.formasolcial'
        db.delete_column(u'contactos_sector', 'formasolcial')

        # Adding field 'Sector.sujeto'
        db.add_column(u'contactos_sector', 'sujeto',
                      self.gf('django.db.models.fields.CharField')(max_length=4, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Sujeto.sufijo'
        db.add_column(u'contactos_sujeto', 'sufijo',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Sujeto.formasocial'
        db.delete_column(u'contactos_sujeto', 'formasocial')

        # Adding field 'Sector.formasolcial'
        db.add_column(u'contactos_sector', 'formasolcial',
                      self.gf('django.db.models.fields.CharField')(max_length=4, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Sector.sujeto'
        db.delete_column(u'contactos_sector', 'sujeto')
    ...
    models = {
        ...
        u'contactos.sector': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nom': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '100'}),
            'sujeto': ('django.db.models.fields.CharField', [], {'max_length': '4', 'null': 'True', 'blank': 'True'})
        },
        ...
        u'contactos.sujeto': {
            ...
            'formasocial': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nom': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '100'})
        },
