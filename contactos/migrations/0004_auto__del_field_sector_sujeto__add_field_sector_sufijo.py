...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Sector.sufijo'
        db.add_column(u'contactos_sector', 'sufijo',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Sector.sufijo'
        db.delete_column(u'contactos_sector', 'sufijo')
    ...
    models = {
        ...
        u'contactos.sector': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nom': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '100'}),
            'sufijo': ('django.db.models.fields.CharField', [], {'max_length': '4', 'null': 'True', 'blank': 'True'})
        },
